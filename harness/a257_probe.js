...
(async () => {
    ...
    page.on('console', m => { const t = m.text(); if (/A25[2-7]\]|A246\]|A244\]|\[S3\]|\[S4\]|\[S5\]|\[S6\]|\[S7\]|\[S9\]|\[S10\]|\[S13\]|despeckle|\[S14\]|\[S16\]|a89:|\[S2[bc]\]|FAILED|rror/.test(t)) console.log('  [page:log] ' + t.slice(0, 400)); });
