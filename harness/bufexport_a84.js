...
const OUT = path.join('/workspace/moebiusv2/harness/bufcache', ASSET + '_a84');
...
(async () => {
  ...
  await page.evaluate(() => { window._noConeFill = true; window._foldProbe = true; window._srCapture = true; bgQuickBake = true; window._bgQuickBaked = false; buildBackgroundLayer(); });
