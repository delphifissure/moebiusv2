...
//   COLOR= DEPTH= FILL=<srcfill out dir> TAG= node harness/srcfill.js
'use strict';
...
(async () => {
    ...
    const info = await page.evaluate(async ([pb64, wb64]) => {
        ...
        return { pw, ph, retear: { pairs, decisionsChanged: flipped }, plate2Hidden: !!p2, ramp: window._qbRampColour ? window._qbRampColour.changed : null, texelsWherePlateDiffersFromAppSource: dqOut };
    }, [plate, wash]);
