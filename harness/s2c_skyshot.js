...
(async () => {
    ...
    page.on('console', m => { const t = m.text(); if (/\[S2[bc]\]|\[S3\]|\[S4\]|\[S5\]|\[S6\]|\[S7\]|\[S9\]|\[S10\]|A245 plug margin|QUICK-BAKE\] A21[26]|FAILED|rror/.test(t)) console.log('  [page:log] ' + t.slice(0, 300)); });
