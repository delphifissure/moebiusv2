...
(async () => {
    ...
    page.on('console', m => { const t = m.text(); if (/\[S6\]|\[S5\]|\[S3\] far side|A245 plug margin|QUICK-BAKE\] (a126|a162|A21[26]|all-viewpoint)|\[S2b\] sweep|failed|rror/.test(t)) console.log('  [page:log] ' + t.slice(0, 260)); });
