// A83: naked-hole attribution — plate islands vs solid, troll at 0.2.
...
(async () => {
  ...
  await page.evaluate(() => { window._noVpScan = true; window._noBgIslands = true; bgQuickBake = true; window._bgQuickBaked = false; buildBackgroundLayer(); });
  ...
  fs.writeFileSync(path.join(OUTD, 'A90_troll_solid.png'), Buffer.from(png.split(',')[1], 'base64'));
  console.log('wrote A90_troll_solid.png');
