...
(async () => {
  ...
  await shoot('A96_cuton.png', '');
  await shoot('A96_cutoff.png', 'const mu = mediaLayers[0].mesh.material.uniforms; window._savedRate = mu.u_bandCutUvRate.value; mu.u_bandCutUvRate.value = 0;');
  await shoot('A96_nomismatch.png', 'const mu = mediaLayers[0].mesh.material.uniforms; mu.u_bandCutUvRate.value = window._savedRate; mu.u_bandCutMismatch.value = 999;');
